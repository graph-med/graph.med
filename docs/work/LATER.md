...
- body-text sentences the rule leaves on the page (every chapter of `pomgat-lv-1.0` relinked under spec §5.1 by WP-0012 and WP-0013), page-anchored: §5.7 sedierende Prämedikation has no box, its text weighs benzodiazepines case by case and names melatonin; p. 78 no recommendation on nasogastric tubes after pylorus-preserving pancreatic head resection, pancreato-gastrostomy and distal pancreatectomy; pp. 92–100 five gap notices outside boxes (methylnaltrexone p. 92, local anaesthetics p. 93, propranolol p. 94, dexmedetomidine p. 95 withheld after the 2022 Rote-Hand-Brief with its own "dringend zu beachten" cautions and no box, laxatives p. 100, each "für andere viszeralonkologische Operationen … keine Empfehlung") and the note that alvimopan is effective but unlicensed in Germany (p. 92); p. 92 the example dose "bspw. 50mg Diclophenac" inside an effect report; p. 87 the description of the TAP technique; p. 105 no RCT data on chewing gum after minimally invasive liver or pancreatic resection and "kann der Einsatz von Kaugummis bei dieser OP-Indikationen erwogen werden" reaching into pancreatic surgery beyond box 7.27; p. 107 the studies' duration and frequency of acupuncture and their definition of early mobilisation; pp. 108–109 the rationale for 7.29's EK; p. 121 "zu anderen Organ-Entitäten … keine Empfehlung" for the specialised nurse, in tension with box 8.7 and to be read with it; open-questions → gap-notices for the declines

- `claims/pomgat-lv-1.0/b0e0ee65` (p. 88, the TAP block with continuous local anaesthetic under 7.12) is stored as `criterion` where its form is a recommendation ("kann … verwendet werden", spec §3.1); an edit with history, id unchanged — noticed while relinking chapter 7 (WP-0013), outside a linking pass's scope

- cross-statement edges (specializes/complements) not yet asserted; first candidates 7.12 (TAP block, minimally invasive colorectal) and 7.13 (peripheral regional analgesia) against 7.9/7.10 (epidural), and 7.2 (early removal of the tube) `complements` 7.1 (the double-lumen tube), the relation the removed 7.2 → 7.1 body-text edge had stood in for
