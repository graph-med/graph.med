...
processed WP-0023, WP-0024 and WP-0025 as one stack, all at `status: review`:
WP-0023 (schema 0.6.0, `claim.evidence`) is the base, WP-0024 (the nine-zone
card) is stacked on it, WP-0025 (zone 4, the evidence states) on WP-0024 at
the top, awaiting its pull request. WP-0016 is in review (#67). WP-0011, WP-0012,
...
- WP-0024 — `agent/2026-09-18-site-statement-card-nine-zones`, review,
  stacked on WP-0023.
- WP-0025 — `agent/2026-09-18-site-evidence-zone`, review, stacked on
  WP-0024, the top of the stack.
